...
using KiteDataHelper.DataAccess;
...
namespace KiteDataHelper.Web
{
    ...
    public class Ticker
    {
        ...
        public delegate void OnTickHandler(Tick TickData, IHubContext<TickerHub> hubContext);
        ...
        private void _onError(string Message, Exception e)
        {
        ...
        private Tick ReadIndexFull(byte[] b, ref int offset)
        {
            ...
            tick.Timestamp = CommonFunctions.UnixToDateTime(time);
            return tick;
        }
        ...
        private Tick ReadFull(byte[] b, ref int offset)
        {
            ...
            tick.LastTradeTime = CommonFunctions.UnixToDateTime(ReadInt(b, ref offset));
            tick.OI = ReadInt(b, ref offset);
            tick.OIDayHigh = ReadInt(b, ref offset);
            tick.OIDayLow = ReadInt(b, ref offset);
            tick.Timestamp = CommonFunctions.UnixToDateTime(ReadInt(b, ref offset));
